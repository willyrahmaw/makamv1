                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror"
                                   value="{{ old('tanggal', $keuangan->tanggal->format('d/m/Y')) }}" placeholder="dd/mm/yyyy" autocomplete="off" required>
                            <small class="text-muted">Contoh: 28/01/2025</small>
                            @error('tanggal')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for="tipe_edit" class="form-label">Tipe <span class="text-danger">*</span></label>
                            <select name="tipe" id="tipe_edit" class="form-select @error('tipe') is-invalid @enderror" required>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sumber" class="form-control @error('sumber') is-invalid @enderror"
                                   value="{{ old('sumber', $keuangan->sumber) }}" placeholder="Contoh: Donasi Jamaah, Perawatan Makam">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="metode" class="form-control @error('metode') is-invalid @enderror"
                                   value="{{ old('metode', $keuangan->metode) }}" placeholder="Tunai, Transfer, QRIS">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="referensi" class="form-control @error('referensi') is-invalid @enderror"
                                   value="{{ old('referensi', $keuangan->referensi) }}" placeholder="No. bukti / transaksi">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="donatur" class="form-control @error('donatur') is-invalid @enderror"
                                   value="{{ old('donatur', $keuangan->donatur) }}" placeholder="Diisi untuk donasi">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="deskripsi" rows="2" class="form-control @error('deskripsi') is-invalid @enderror"
                                      placeholder="Keterangan singkat penggunaan dana / sumber dana">{{ old('deskripsi', $keuangan->deskripsi) }}</textarea>
